          ...
          <div className="bg-surface-container-lowest rounded-xl shadow-[0px_4px_20px_rgba(0,0,0,0.05)] border border-outline-variant overflow-hidden">
            ...
            {selectedGroup ? (
              <>
                <div className="p-sm bg-surface-container-lowest border-b border-outline-variant flex items-center justify-between">
                  <span className="font-body-sm text-outline">Splitting equally in <span className="font-semibold text-on-surface">{selectedGroup.name}</span></span>
            ...
            <div className="bg-surface-container-high p-md">
              <div className="flex justify-between items-center mb-sm">
                ...
                <span className="font-headline-md text-headline-md text-on-surface">${splitAmount.toFixed(2)}</span>
              </div>
              <button 
                onClick={handleConfirm} 
                disabled={saving || !selectedGroup || !title.trim() || totalAmount <= 0} 
